<script>
  import CardMain from './icons/CardMain.vue' 
</script>
<template>
  <main>
    <section>
      ...
      <div class="container d-flex align-items-center main-content">
        <div class="col-5 text-main  ">
          ...
          <a href="https://calendly.com/neto-nelsonfsa/30min" class="btn btn-outline-success mt-5" target="_blank"  > Agendar visita</a>
        </div>
        <div class="col-4">
          <img class="img-banner" src="../../public/assets/bannerMain.png"/>
        </div>
      </div> 
    </section> 
    ...
    <section class="testemunhas">
      <div class="elfsight-app-8460201d-2155-42c7-b1a3-74f18780890a" data-elfsight-app-lazy></div>
    </section>
  </main>
</template>
...
<style scoped>
  ...
  @import '../assets/main-responsivo.css';
</style>
